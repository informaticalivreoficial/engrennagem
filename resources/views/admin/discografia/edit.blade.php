...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Editar Disco</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Painel de Controle</a></li>
            <li class="breadcrumb-item"><a href="{{route('discografia.index')}}">Discos</a></li>
            <li class="breadcrumb-item active">Editar Disco</li>
        </ol>
    </div>
</div> 
@stop
...
<form action="{{ route('discografia.update',['id' => $disco->id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf
@method('PUT')       
<div class="row">            
<div class="col-12">
    ...
    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
            ...
            <div class="col-12 col-md-6 col-lg-4"> 
                <div class="form-group">
                    <div class="thumb_user_admin">
                        <img id="preview" src="{{$disco->cover()}}" alt="{{ old('titulo') ?? $disco->titulo }}" title="{{ old('titulo') ?? $disco->titulo }}"/>
                ...
                <div class="row mb-2">
                    <div class="col-12 col-md-8 col-lg-8"> 
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="titulo" value="{{ old('titulo') ?? $disco->titulo }}">
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4"> 
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" {{ (old('status') == '1' ? 'selected' : ($disco->status == '1' ? 'selected' : '')) }}>Ativo</option>
                                <option value="0" {{ (old('status') == '0' ? 'selected' : ($disco->status == '0' ? 'selected' : '')) }}>Inativo</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12 col-md-12 col-lg-12"> 
                        <div class="form-group">
                            ...
                            <input id="tags_1" class="tags" rows="5" name="tags" value="{{ old('tags') ?? $disco->tags }}">
                        </div>
                    </div>           
                </div>
            </div>            
        ...
        <div class="row mb-2">
            <div class="col-12 mb-1"> 
                <div class="form-group">
                    ...
                    <x-adminlte-text-editor name="ficha_tecnica" v placeholder="Ficha Técnica..." :config="$config">{{ old('ficha_tecnica') ?? $disco->ficha_tecnica }}</x-adminlte-text-editor>
            ...
            <div class="col-12 col-md-12 col-lg-6"> 
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="deezer" value="{{ old('deezer') ?? $disco->deezer }}">
                </div>
            </div>                    
            <div class="col-12 col-md-12 col-lg-6"> 
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Spotify</b> </label>
                    <input type="text" class="form-control" name="spotify" value="{{ old('spotify') ?? $disco->spotify }}">
                </div>
            </div>                    
            <div class="col-12 col-md-12 col-lg-6"> 
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Apple Music</b> </label>
                    <input type="text" class="form-control" name="apple_music" value="{{ old('apple_music') ?? $disco->apple_music }}">
                </div>
            </div>                    
            <div class="col-12 col-md-12 col-lg-6"> 
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Itunes</b> </label>
                    <input type="text" class="form-control" name="itunes" value="{{ old('itunes') ?? $disco->itunes }}">
                </div>
            </div>                    
            <div class="col-12 col-md-12 col-lg-6"> 
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Music</b> </label>
                    <input type="text" class="form-control" name="music" value="{{ old('music') ?? $disco->music }}">
                </div>
            </div>                    
            <div class="col-12 col-md-12 col-lg-6"> 
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Youtube</b> </label>
                    <input type="text" class="form-control" name="youtube" value="{{ old('youtube') ?? $disco->youtube }}">
                </div>
            </div>
        </div>
        ...
        <div class="row mb-2">
            <div class="col-12">   
                ...
                <textarea class="form-control" rows="5" name="letras">{{ old('letras') ?? $disco->letras }}</textarea>                                                                                     
            </div>            
        </div>
