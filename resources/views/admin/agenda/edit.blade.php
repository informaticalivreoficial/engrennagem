...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Editar Evento</h1>
    </div>
    <div class="col-sm-6">
...
<form action="{{ route('agenda.update',['id' => $evento->id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf
@method('PUT')       
<div class="row">            
<div class="col-12">
    ...
    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
            ...
            <div class="col-12 col-md-6 col-lg-4"> 
                <div class="form-group">
                    <div class="thumb_user_admin">
                        <img id="preview" src="{{$evento->cover()}}" alt="{{ old('titulo') ?? $evento->titulo }}" title="{{ old('titulo') ?? $evento->titulo }}"/>
                ...
                <div class="row mb-2">
                    <div class="col-12 col-md-8 col-lg-8"> 
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="titulo" value="{{ old('titulo') ?? $evento->titulo }}">
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4"> 
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" {{ (old('status') == '1' ? 'selected' : ($evento->status == '1' ? 'selected' : '')) }}>Ativo</option>
                                <option value="0" {{ (old('status') == '0' ? 'selected' : ($evento->status == '0' ? 'selected' : '')) }}>Inativo</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12"> 
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="endereco" value="{{ old('endereco') ?? $evento->endereco }}">
                        </div>
                    </div> 
                    <div class="col-12 col-md-6 col-lg-6 mb-2"> 
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control datepicker-here" data-language='pt-BR' name="data" value="{{ old('data') ?? $evento->data }}"/>
                    ...
                    <div class="col-12 col-md-12 col-lg-6"> 
                        ...
                        @endphp
                        <x-adminlte-input-date name="time" :config="$configtime" value="{{ old('time') ?? $evento->time }}">
        ...
        <div class="row mb-2">
            <div class="col-12">   
                ...
                <x-adminlte-text-editor name="content" v placeholder="Descrição..." :config="$config">{{ old('content') ?? $evento->content }}</x-adminlte-text-editor>                                                                                     
            </div>            
        </div>
